...
// it is an abstract class, which means it can not be instantiated with new
//also, SimplePointMarker m=new Marker() is wrong because marker is an interface, cannot be instantiated. 
